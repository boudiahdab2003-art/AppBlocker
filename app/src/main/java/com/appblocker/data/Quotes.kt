...
object Quotes {
    ...
    private val ALL = listOf(
        ...
        // Time & attention
        Quote("Where your attention goes, your life goes."),
        ...
        Quote("Your attention is the most valuable thing you own. Spend it on purpose."),
        ...
        Quote("Every minute you scroll is a minute you traded away."),
        Quote("Guard your time fiercely. It is your life in small pieces."),
        ...
        Quote("Small daily wins become unstoppable momentum."),
        Quote("You don't have to be great to start, but you have to start to be great.", "Zig Ziglar"),
        Quote("Every time you resist, the next time gets easier."),
        Quote("Success is the sum of small efforts, repeated day in and day out.", "Robert Collier"),
        Quote("Hard choices, easy life. Easy choices, hard life.", "Jerzy Gregorek"),
        Quote("The best way to break a habit is to never feed it."),

        // Beating the phone / distraction
        Quote("Your phone is a tool. Don't let it become your master."),
        Quote("The apps are designed to hook you. You are designed to overcome."),
        Quote("Real life is happening right now, off this screen."),
        Quote("Boredom is where your best ideas are hiding. Let yourself be bored."),
        Quote("You blocked this for a reason. Trust the person who set that block."),
        Quote("Nothing on that app will matter in a week. What you do instead might."),
        Quote("This craving will pass in ninety seconds. Breathe and walk away."),
        Quote("You are not missing out. You are opting in — to your own life."),
        Quote("Every scroll you skip is a rep for your willpower."),
        Quote("The feed never ends. Your time does."),

        // Punchy modern one-liners
        Quote("Your future self is watching. Make them proud."),
        Quote("One day, or day one. You decide."),
        Quote("Don't trade your goals for a dopamine hit."),
        Quote("Strong people build habits. Weak moments break them. Stay strong."),
        Quote("You've already won this battle once — you set this block. Win it again."),
        Quote("Progress, not perfection. Closing this screen counts."),
        Quote("Great things never came from comfort zones."),
        Quote("Focus is a superpower in a distracted world."),
