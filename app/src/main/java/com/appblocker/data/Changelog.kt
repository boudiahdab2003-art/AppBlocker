...
val changelog: List<VersionLog> = listOf(
    VersionLog("1.111", "Jul 29, 2026", "Your screen time was wrong, and the coach now says what went wrong", listOf(
        ...
        "**The block screen forgot which word it caught.** When a blocked word is found, the app locks that whole app for a while and the cover says \"'casino' was found here\" — naming the word is most of what makes that screen land. But the word was only ever held in memory: it was never written down with the lockout, so after any restart — a reboot, an app update, or your phone killing and restarting the blocker — the same lockout carried on with the vague \"A blocked word was found here\" instead. Now it's saved with the lockout, including words containing punctuation.",
