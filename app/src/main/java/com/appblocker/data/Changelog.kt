...
val changelog: List<VersionLog> = listOf(
    VersionLog("1.110", "Jul 29, 2026", "Strict Mode stops blocking all of Settings, and uninstalling gets harder", listOf(
        ...
        "The same gate now guards the copy of that switch in **Setup & permissions**. It was a second, free door to the same thing, which would have made the gate on the first one decorative.",
