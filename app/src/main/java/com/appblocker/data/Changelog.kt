...
val changelog: List<VersionLog> = listOf(
    VersionLog("1.100", "Jul 25, 2026", "A much smarter coach, and clock changes can't weaken blocking", listOf(
        ...
        "You can now choose how the block screen looks. Profile ▸ Block screen has four: **Midnight** (the one you have now), **Aurora** (the blue-violet gradient edge to edge), **Paper** (light, for daylight) and **Ink** (pure black with no colour at all — nothing to look at, which is arguably the point of a block screen). It is purely how it looks: same information, same Got it button, and nothing about blocking changes.",
